...
function spider_display_embed(embed_type, file_url, embed_id, attrs) {
  ...
  switch(embed_type) {
    case 'EMBED_OEMBED_YOUTUBE_VIDEO':
      ...
      if(embed_id!=''){
        oembed_youtube_html += ' src="' + '//web.archive.org/web/20181107013125/https://www.youtube.com/embed/'+ embed_id + '?enablejsapi=1&wmode=transparent"';
      }
      for (attr in attrs) {
        if(!(/src/i).test(attr)){
          if(attr != '' && attrs[attr] != ''){
    ...
    case 'EMBED_OEMBED_VIMEO_VIDEO':
      ...
      if(embed_id!=''){
        oembed_vimeo_html += ' src="' + '//web.archive.org/web/20181107013125/https://player.vimeo.com/video/'+embed_id + '?enablejsapi=1"';
      }
      for (attr in attrs) {
        if(!(/src/i).test(attr)){
          if(attr != '' && attrs[attr] != ''){
    ...
    case 'EMBED_OEMBED_INSTAGRAM_IMAGE':
      ...
      oembed_instagram_html += " >";
        ...
        oembed_instagram_html += '<img src="//web.archive.org/web/20181107013125/https://instagram.com/p/'+embed_id+'/media/?size=l"'+ 
        ' style=" '+
        'max-width:'+'100%'+" !important"+
        '; max-height:'+'100%'+" !important"+
        '; width:'+'auto'+
    ...
    case 'EMBED_OEMBED_INSTAGRAM_POST':
      ...
      oembed_instagram_html += " >";
        if(embed_id!=''){
        oembed_instagram_html += '<iframe class="inner_instagram_iframe_'+obj_class+'" src="//web.archive.org/web/20181107013125/https://instagr.am/p/'+embed_id+'/embed/?enablejsapi=1"'+ 
        ' style="'+
        'max-width:'+'100%'+" !important"+
        '; max-height:'+'100%'+" !important"+
        '; width:'+'100%'+
	...
	case 'EMBED_OEMBED_FACEBOOK_VIDEO': 
      ...
      if(embed_id!=''){
        oembed_facebook_video_html += '<iframe src="//web.archive.org/web/20181107013125/https://www.facebook.com/video/embed?video_id='+file_url+'&enablejsapi=1&wmode=transparent"' +
        ' style="'+
        'max-width:'+'100%'+" !important"+
        '; max-height:'+'100%'+" !important"+
        '; width:'+'100%'+
    ...
    case 'EMBED_OEMBED_DAILYMOTION_VIDEO':
      ...
      if(embed_id!=''){
        oembed_dailymotion_html += ' src="' + '//web.archive.org/web/20181107013125/https://www.dailymotion.com/embed/video/'+embed_id + '?api=postMessage"';
      }
      for (attr in attrs) {
        if(!(/src/i).test(attr)){
          if(attr != '' && attrs[attr] != ''){
...
/*
     FILE ARCHIVED ON 01:31:25 Nov 07, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:59:16 Nov 12, 2020.
...
playback timings (ms):
  ...
  RedisCDXSource: 2.537
  PetaboxLoader3.datanode: 82.582 (4)
  load_resource: 47.489
  esindex: 0.019
  LoadShardBlock: 108.052 (3)
  captures_list: 137.185
  PetaboxLoader3.resolve: 26.74
  CDXLines.iter: 21.625 (3)
