    ...
    if (typeof data[current_key] != 'undefined') {
      ...
      */
      ...
      function bwg_afterload() {
        ...
        jQuery("#bwg_facebook_a").attr("href", "https://web.archive.org/web/20181107013128/https://www.facebook.com/sharer/sharer.php?u=" + bwg_share_url);
        jQuery("#bwg_twitter_a").attr("href", "https://web.archive.org/web/20181107013128/https://twitter.com/share?url=" + bwg_share_url);
        jQuery("#bwg_google_a").attr("href", "https://web.archive.org/web/20181107013128/https://plus.google.com/share?url=" + bwg_share_url);
        jQuery("#bwg_pinterest_a").attr("href", "https://web.archive.org/web/20181107013128/http://pinterest.com/pin/create/button/?s=100&url=" + bwg_share_url + "&media=" + bwg_share_image_url + "&description=" + data[key]['alt'] + '%0A' + data[key]['description']);
        jQuery("#bwg_tumblr_a").attr("href", "https://web.archive.org/web/20181107013128/https://www.tumblr.com/share/photo?source=" + bwg_share_image_url + "&caption=" + data[key]['alt'] + "&clickthru=" + bwg_share_url);
        /* Load comments.*/
...
/*
     FILE ARCHIVED ON 01:31:28 Nov 07, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:59:17 Nov 12, 2020.
...
/*
playback timings (ms):
  load_resource: 1720.105
  RedisCDXSource: 63.368
  esindex: 0.014
  captures_list: 418.417
  LoadShardBlock: 326.685 (3)
  exclusion.robots: 0.213
  PetaboxLoader3.datanode: 323.257 (4)
  exclusion.robots.policy: 0.197
  CDXLines.iter: 23.211 (3)
  PetaboxLoader3.resolve: 1523.713
*/